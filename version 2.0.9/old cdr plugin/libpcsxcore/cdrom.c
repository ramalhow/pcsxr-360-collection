...
//			AddIrqQueue(CdlPause + 0x20, 0x800);
			AddIrqQueue(CdlPause + 0x20, cdReadTime * 3); //FF7 slowdown fix
			cdr.Ctrl |= 0x80;
			break;
...
//			AddIrqQueue(cdr.Cmd, cdReadTime * 3);
			AddIrqQueue(cdr.Cmd, 0x800);//FF7 slowdown fix
			break;
...
//	psxHu8(0x1803) = 0xff;}
//else{
	psxHu8_2(0x1803) = 0xff;//}//teste
	} else {
//		if (use_vm){
//			psxHu8(0x1803) = 0;}
//		else{
			psxHu8_2(0x1803) = 0;//}//teste
	}
