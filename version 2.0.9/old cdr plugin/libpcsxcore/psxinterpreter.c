...
//else{
	_i32(_rRt_) = (signed char)psxMemRead8_2(_oB_);//} //teste
	} else {
//if(use_vm){
//	psxMemRead8(_oB_); }
//else{
	psxMemRead8_2(_oB_);//} //teste
	}
}
...
//else{
	_u32(_rRt_) = psxMemRead8_2(_oB_);//}//teste
	} else {
//if(use_vm){
//	psxMemRead8(_oB_);}
//else{
...
//else{
	_i32(_rRt_) = (short)psxMemRead16_2(_oB_);//}//teste
	} else {
//if(use_vm){
//	psxMemRead16(_oB_);}
//else{
	psxMemRead16_2(_oB_);//}//teste
	}
}
...
//else{
	_u32(_rRt_) = psxMemRead16_2(_oB_);//}//teste
	} else {
//if(use_vm){
//	psxMemRead16(_oB_);}
//else{
...
//else{
	_u32(_rRt_) = psxMemRead32_2(_oB_);//}//teste
	} else {
//if(use_vm){
//	psxMemRead32(_oB_);}
//else{
	psxMemRead32_2(_oB_);//}//teste
	}
}
...
//else{
	mem = psxMemRead32_2(addr & ~3);//}//teste
...
//void psxSB() { if (use_vm) {psxMemWrite8 (_oB_, _u8 (_rRt_)); }else {psxMemWrite8_2 (_oB_, _u8 (_rRt_)); }}//teste
//void psxSH() { if (use_vm) {psxMemWrite16(_oB_, _u16(_rRt_)); }else {psxMemWrite16_2(_oB_, _u16(_rRt_)); }}//teste
//void psxSW() { if (use_vm) {psxMemWrite32(_oB_, _u32(_rRt_)); }else {psxMemWrite32_2(_oB_, _u32(_rRt_)); }}//teste
